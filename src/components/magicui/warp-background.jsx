...
export const WarpBackground = ({
  ...
  return (
    <div
      className={cn("relative rounded border p-10 lg:p-20", className)}
      {...props}
    >
      <div
        style={{
        ...
        className={
          "pointer-events-none absolute left-0 top-0 opacity-80 size-full overflow-hidden [clip-path:inset(0)] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
        }
      >
        {/* top side */}
