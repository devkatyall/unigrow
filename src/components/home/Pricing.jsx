...
export default function Pricing() {
  ...
  const path = useTransform(scrollYProgress, [0.96, 1], [0, 1]);
  ...
  return (
    <>
      <section
        ref={ref}
        className="md:my-6 md:px-16 lg:py-16 px-8 py-3 my-6 h-[200vh]"
      >
          ...
          <motion.div style={{ display: d2, opacity: yo2, x: y2 }}>
            <div>
              ...
              <p className=" text-sm md:text-base xl:text-2xl lg:px-[10%] text-center mb-4 mt-2 text-white">
                With Unigrow, you get an all-in-one solution at a fraction of
                the price. We ask for your vision and bring it to life. Simple,
                right?
              </p>
            </div>
          </motion.div>
