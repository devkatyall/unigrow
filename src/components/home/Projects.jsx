...
export default function Projects() {
  ...
  return (
    <section ref={targetRef} className=" h-[200vh]">
      <div className="sticky top-5 h-screen flex flex-col justify-center text-[#ececec1c]">
        <h3 className="w-full  md:text-6xl mb-10 text-center ">
        ...
        <motion.div className="flex gap-6 md:ml-[25%]" style={{ x }}>
          {projects.map((e, i) => (
            <motion.Card key={i} className="w-[30vw] rounded-2xl px-6 py-10 ">
