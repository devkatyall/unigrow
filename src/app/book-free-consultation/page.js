...
export const metadata = {
  title: "Book a Free Consultation | Unigrow",
  description:
    "Get expert advice on your website, SEO, and online presence. Book a free 15-minute consultation with Unigrow today and start growing your business online.",
  keywords:
    "free consultation, website consultation, SEO strategy, web development advice, Unigrow consultation, digital strategy session",
  openGraph: {
    type: "website",
        ...
        <section id="book-now" className=" mx-auto w-[87vw] pb-[10vh]">
          ...
          >
            <div className="lg:w-1/2 space-y-[3vh]">
              ...
              <SubText>
                Need a high-performing website or e-commerce store? Whether
                you’re starting fresh, redesigning an existing site, or looking
                to optimize for SEO and conversions, our experts are here to
                help.
              </SubText>
          ...
          <Main className={" flex justify-between items-center gap-[8vh]"}>
            <div className=" space-y-[2vh]">
              ...
              <SubText className={"lg:px-[10vw]"}>
                ...
                security, Unigrow websites ensure a seamless user experience
                while helping businesses rank higher on Google.
              </SubText>
            </div>
        ...
        <section className="space-y-[10vh] py-[10vh] bg-blue-600/20">
          <div>
            ...
            <SubText className={"text-center"}>
              Unigrow delivers a complete website development experience,
              removing the complexity of multiple service providers.
            </SubText>
          </div>
...
function StructuredData() {
  const structuredData = {
    ...
    serviceType: "SEO and Web Development Consultation",
    areaServed: {
      "@type": "Country",
      name: "Canada",
    },
