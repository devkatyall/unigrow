...
export const metadata = {
  title: "Create a Stunning Portfolio | Unigrow",
  description:
    "Turn your best work into a client-attracting portfolio. Whether you're a freelancer, student, or business owner, a strong portfolio boosts credibility and helps win more clients or job opportunities.",
  keywords:
    "portfolio creation, professional portfolio, online portfolio, freelancer portfolio, student portfolio, business owner portfolio, portfolio SEO",
  openGraph: {
    type: "website",
    url: "https://www.unigrow.ca/services/portfolio-creation",
    title: "Create a Stunning Portfolio | Unigrow",
    description:
      "Turn your best work into a client-attracting portfolio. Whether you're a freelancer, student, or business owner, a strong portfolio boosts credibility and helps win more clients or job opportunities.",
    images: [
      ...
      <main className=" flex flex-col gap-[10vh]">
        <section>
          <Main className={"py-[4vh]"}>
            ...
            <MainText>
              Struggling to present your work online? Whether you’re a
              freelancer, creative professional, student, or business owner, a
              well-structured portfolio builds credibility and helps you win
              more clients or job opportunities.
            </MainText>
            ...
            <ul className=" grid md:grid-cols-3 gap-[4vw] my-[6vh]">
              <li>
                ...
                <p className=" text-sm lg:text-base text-cyan-400/50">
                  Clients and employers are more likely to work with you when
                  they see proof of your skills.
                </p>
              </li>
              <li>
                <h4 className=" text-xl lg:text-2xl font-extralight">
              ...
              <li>
                ...
                <p className=" text-sm lg:text-base text-cyan-400/50">
                  SEO-optimized portfolios rank higher in search results,
                  bringing you more opportunities.
                </p>
              </li>
            </ul>
          </Sub>
        ...
        <ImageSec image={students} className={"opacity-35 blur-sm"}>
          ...
          >
            ...
            <SubText className="text-white w-[95%] md:w-[90%]">
              In today’s competitive job market, a professional portfolio is
              just as important as a resume. If you’re a student or recent
              graduate, showcasing your skills and projects online can cause you
              wonders, because you competiting against the candidates who has
              one.
            </SubText>
            <AnimatedLink href={"/book-free-consultation"}>
              <Button className=" w-fit text-lg py-[3vh] font-bold">
...
function StructuredData() {
  const structuredData = {
    ...
    "@type": "WebPage",
    name: "Portfolio Creation | Unigrow",
    url: "https://www.unigrow.ca/services/portfolio-creation",
    description:
      "Turn your best work into a client-attracting portfolio. Whether you're a freelancer, student, or business owner, a strong portfolio boosts credibility and helps win more clients or job opportunities.",
    publisher: {
