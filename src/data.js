...
export const why_book = {
  title: "Why Book a Meeting with Us?",
  subtitle: "Get Expert Advice, Without the Sales Pitch",
  cards: [
    {
      icon: (
        <svg
      ...
      heading: "100% Free Consultation",
      description:
        "No obligations, just valuable insights tailored to your business needs.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Tailored recommendations based on your website or e-commerce goals.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Guidance on Shopify, WooCommerce, Magento, or custom-built websites.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Walk away with a clear strategy to improve your online presence.",
    },
  ],
  cta: "Book Your Free Meeting",
};
